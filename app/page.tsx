    ...
    <main className="min-h-[72vh] bg-[linear-gradient(135deg,#eef5ff_0%,#ffffff_55%,#fff7d7_100%)]">
      <section className="mx-auto max-w-6xl px-5 py-12 sm:py-20">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          <article className="flex flex-col rounded-3xl border border-line bg-white p-6 shadow-md">
          ...
          <article className="flex flex-col rounded-3xl border border-accent bg-[#fff7d7] p-6 shadow-md">
